...
How to use Hyperopt Optimisation
================================
...
In this guide, we will explain how to configure optimisation such that RecPack uses hyperopt to optimise hyperparameters.
