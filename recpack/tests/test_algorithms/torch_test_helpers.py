    ...
    for (_, p0), (name, p1) in zip(initial_params, params):
        try:
            ...
            raise VariablesChangeException(  # error message
                "{var_name} {msg}".format(
                    var_name=name, msg="did not change!" if vars_change else "changed!"
                )
            )
  ...
  """
    ...
    try:
        ...
        raise RangeException(
            "All elements of tensor are less than {value}".format(value=value)
        )
...
def assert_all_greater_than(tensor, value):
  ...
  """
    ...
    try:
        ...
        raise RangeException(
            "Some elements of tensor are less than {value}".format(value=value)
        )
...
def assert_any_less_than(tensor, value):
  ...
  """
    ...
    try:
        ...
        raise RangeException(
            "All elements of tensor are greater than {value}".format(value=value)
        )
...
def assert_all_less_than(tensor, value):
  ...
  """
    ...
    try:
        ...
        raise RangeException(
            "Some elements of tensor are greater than {value}".format(value=value)
        )


def assert_input_dependency(
    model, loss_fn, optim, batch, independent_vars=None, dependent_vars=None
):
